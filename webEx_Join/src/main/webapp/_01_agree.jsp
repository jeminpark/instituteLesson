...
<body>
    ...
    <form method= "GET" action = "_03_join.jsp">
        ...
        <ul>
            ...
            <li><input type = "checkbox" class = "box1" name = "necessary"><span>개인정보 수집및 이용동의(필수)
            ...
            <li><input type = "checkbox" class = "box1" name = "choice"><span>위치정보 이용약관 동의(선택)
            ...
            <li><input type = "checkbox" class = "box1" name = "choice"><span>프로모션 정보수신동의(선택)
